package com.tsvico.mobike.activity.login;
/*********
 *
 * 手机号登录
 */
...
import com.tsvico.mobike.base.BaseActivity;
import com.tsvico.mobike.bean.Credit;
import com.tsvico.mobike.bean.MyRedPocketData;
import com.tsvico.mobike.bean.MyUser;
import com.tsvico.mobike.bean.RideSummary;
import com.tsvico.mobike.utils.ToastUtils;
import com.tsvico.mobike.views.ClearEditText;
import com.tsvico.mobike.views.CountTimerView;
...
public class LoginActivity extends BaseActivity {
    ...
    private void initDate() {
        SMSSDK.initSDK(this, "283b02f468a11", "6ee9b1a0eb2d67487041f14a61ecc667");
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.login_services:
                Toast.makeText(this,"这里什么都没有",Toast.LENGTH_SHORT).show();
                break;
        }
    }
